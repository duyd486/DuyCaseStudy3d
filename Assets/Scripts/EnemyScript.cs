...
public class EnemyScript : MonoBehaviour
{
    ...
    private void Attack()
    {
        ...
        playerCombat.currentHealth = playerCombat.currentHealth - damage;
    }
